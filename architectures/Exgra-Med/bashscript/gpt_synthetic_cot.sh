# This script is used to train model with input image, question, GPT-based synthetic visual chain-of-thought, and final prediction (Q4).
...
prompt_mode=cot
use_rag=false
version=_exgra_med_on_CoT_dataset_epochs${epochs}_batchsize${batchsize}_lr${lr}_prompt_mode_${prompt_mode}_useRAG${use_rag}_syntheticCoT
